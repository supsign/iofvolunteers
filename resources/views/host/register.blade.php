                    ...
                    <div class="col-12 col-md-6">
                        <div class="formSection">
                            ...
                            <div class="form-group">
                                ...
                                <img for="country" class="selectArr selectArrComponents"
                            ...
                            <div class="form-group">
                                <input placeholder=" " type="text" size="3" name="maxDuration" id="maxDuration"
                                       value="">
                                <label class="formGroupLabel" for="maxDuration">Max hosting duration "" weeks</label>
                            </div>

                            <div class="form-group">
                                <textarea placeholder=" " rows="2" cols="30" name="hostDesc" id="hostDesc"
                                          value=""></textarea>
                                <label class="formGroupLabel" for="hostDesc">Host description</label>
                            </div>

                            <div class="form-group">
                                <textarea placeholder=" " rows="2" cols="30" name="guestExpectations"
                                          id="guestExpectations" value=""></textarea>
                        ...
                        <div class="formSection">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="offer[food]"
                                           id="offer1">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="offer[accomodation]"
                                           id="offer2">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1"
                                           name="offer[local_tourism]" id="offer3">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="offer[o-training]"
                                           id="offer4">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="offer[events]"
                                           id="offer5">
                            ...
                            <div class="form-group">
                                <input id="field_offer3" placeholder=" " type="text"
                                       name="offer[distance_to_public_transport]" value="1 mile">
                                <label class="formGroupLabel" for="field_offer3">Distance to public transport:</label>
                            </div>

                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="offer[loan_bike]"
                                           id="offer6">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="offer[loan_car]"
                                           id="offer7">
