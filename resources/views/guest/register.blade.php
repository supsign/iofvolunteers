        ...
        <div class="container">
            <div class="titleWrap">
                <h1 class="pb-0 title"><img class="title-icon" src="{{asset('images/icon-add5.svg')}}" width="65"
                                            height="65"> Guest Registration Form</h1>
            </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="formSection">
                            ...
                            <div class="form-group">
                                ...
                                <img for="country_id" class="selectArr selectArrComponents"
                            ...
                            <div class="form-group">
                                ...
                                <img for="gender_id" class="selectArr selectArrComponents"
                                     src="{{asset('images/selectArr.svg')}}" alt=""/>
                            </div>
                        ...
                        <div class="formSection">
                            ...
                            <div class="form-group">
                                <input type="number" min="1900" max="2099" step="1" name="startO" size="4"
                                       id="field_startO" class="datepicker-here" data-language='en'
                                       data-date-format="yyyy" data-view="years" data-min-view="years" placeholder=" "
                                       value="">
                                <label class="formGroupLabel" for="field_startO">Year you started orienteering (yyyy)
                                    *</label>
                                <img for="field_startO" class="selectArr v2" src="{{asset('images/calendarIcon.svg')}}"
                                     alt=""/>
                            </div>
                        ...
                        <div class="formSection">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[English][level]"
                                           value="Excellent" id="languages1_2">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[French][level]"
                                           value="Excellent" id="languages2_2">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[Spanish][level]"
                                           value="Excellent" id="languages3_2">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[German][level]"
                                           value="Excellent" id="languages4_2">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[Italian][level]"
                                           value="Excellent" id="languages5_2">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[Portuguese][level]"
                                           value="Excellent" id="languages6_2">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="languages[Scandinavian][level]"
                                           value="Excellent" id="languages7_2">
                        ...
                        <div class="formSection">
                            <div class="form-group">
                                <textarea placeholder=" " rows="2" cols="30" name="oExpectations" id="oExpectations"
                                          value=""></textarea>
                                <label class="formGroupLabel" for="oExpectations">O-expectations</label>
                            </div>

                            <div class="form-group">
                                <textarea placeholder=" " rows="2" cols="30" name="motivation" id="motivation"
                                          value=""></textarea>
                                <label class="formGroupLabel" for="motivation">Motivation</label>
                            </div>

                            <div class="form-group">
                                <textarea placeholder=" " rows="2" cols="30" name="healthRestrictions"
                                          id="healthRestrictions" value=""></textarea>
                                <label class="formGroupLabel" for="healthRestrictions">Allergies / medical
                                    restrictions</label>
                            </div>

                            <div class="form-group">
                                <textarea placeholder=" " rows="2" cols="30" name="offer" id="offer"
                                          value=""></textarea>
