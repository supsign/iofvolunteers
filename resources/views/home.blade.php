...
<section class="page_img">
    <img border="0" src="{{ $path }}/pg_template1.jpg" />
        ...
        <div class="row">
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-add.svg" width="50" height="50">
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-search1.svg" width="50" height="50">
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-add3.svg" width="50" height="50">
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-search3.svg" width="50" height="50">
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-add4.svg" width="50" height="50">
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-search4.svg" width="50" height="50">
                            <a href="host/search">
                                Find a host family
                            </a>
                        </h3>
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-add5.svg" width="50" height="50">
            ...
            <div class="col-12 col-md-6 pt-3 pb-3">
                <div class="NI_wrap shadow">
                    <div class="NI_details  p-4">
                        <h3 class="subtitle">
                            <img src="{{ $path }}/icon-search5.svg" width="50" height="50">
                            <a href="guest/search">
                                Search a guest
                            </a>
                        </h3>
